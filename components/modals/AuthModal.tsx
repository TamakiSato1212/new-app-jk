...
export const AuthModal = ({ isOpen, onClose, onSuccess }: Props) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-[300] flex items-center justify-center p-4 font-sans" onClick={onClose}>
      <div className="w-full max-w-md bg-white rounded-3xl p-6 shadow-2xl border border-gray-100 flex flex-col gap-4 animate-fade-in-up" onClick={e => e.stopPropagation()}>
